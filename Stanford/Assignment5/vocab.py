...
class VocabEntry(object):
    ...
    def add(self, word):
        ...
        @param word: word to add to VocabEntry -- string
    ...
    def words2charindices(self, sents):
        ...
        @param sents: sentence(s) in words -- list[list[str]]
    ...
    def indices2words(self, word_ids):
        ...
        @param word_ids: list of word ids -- list[int]
    ...
    def to_input_tensor_char(self, sents: List[List[str]],
        ...
        @param sents: list of sentences (words) -- List[List[str]]
        ...
        # TODO:
        #     - Use `words2charindices()` from this file, which converts each character to
        #       its corresponding index in the character-vocabulary.
        #     - Use `pad_sents_char()` from utils.py, which pads all words to max_word_length
        #       of all words in the batch,
        #       and pads all sentences to max length of all sentences in the batch.
        #       Read __init__ to see how to get index of character-padding token
        #     - Connect these two parts to convert the resulting padded sentences to a torch tensor.
        #  HINT:
        #     - You may find .contiguous() useful after reshaping.
    ...
    def from_corpus(corpus, size, freq_cutoff=2):
        ...
        @param corpus: corpus of text produced by read_corpus function -- list[str]
        @param size: # of words in vocabulary -- int
        @param freq_cutoff: if word occurs n < freq_cutoff times, drop the word -- int
...
class Vocab(object):
    ...
    def build(src_sents, tgt_sents, vocab_size, freq_cutoff) -> 'Vocab':
        """ Build Vocabulary.
        @param src_sents: Source sentences provided by read_corpus() function -- list[str]
        @param tgt_sents: Target sentences provided by read_corpus() function -- list[str]
        @param vocab_size: Size of vocabulary for both source and target languages -- int
        @param freq_cutoff: if word occurs n < freq_cutoff times, drop the word -- int
        """
    ...
    def save(self, file_path):
        ...
        @param file_path: file path to vocab file -- str
        """
